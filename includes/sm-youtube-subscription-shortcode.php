...
class SMYoutubeSubscribeSettingsPage
{
    ...
    public function create_sm_youtube_subscribe_admin_page()
    {
        ...
        ?>
        <div class="wrap">
            <h1>Awesome YouTube Subscribe</h1>
            ...
            <div class="shortcode_info" style="background: #fff;padding: 10px 20px;">
            	<h2>Short Code:</h2>
            	<code>[Awesome-youtube-subscribe]</code>
            </div>
        </div>
        <?php
    }
    ...
    {        
        ...
        add_settings_section(
            ...
            'Awesome YouTube Subscribe Settings', // Title
...
add_shortcode( 'Awesome-youtube-subscribe', 'sm_youtube_subscribe_shortcode' );
